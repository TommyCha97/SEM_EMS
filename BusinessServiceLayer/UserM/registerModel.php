...
// $max2=$data['total']+1;
// $max="S_".$max2;
$sql = "INSERT INTO Supplier (S_SSMNo,S_CompanyName,S_emailAddress,S_password,S_supplierType,S_phoneNO)
             VALUES ('$ssm','$companyName','$email','$psw','$supplierType','$phoneNo')";
