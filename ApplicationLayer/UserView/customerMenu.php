...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="customerMenu.php">Event Management System</a>
...
$id1=$_GET['id'];
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="customerMenu.php">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <h6 class="dropdown-header">Event and Equipment:</h6>
               <!--Equipment Page -->
            <a class="dropdown-item" href="cViewEventPackage.php?idC_1" >Event Package</a>
            <a class="dropdown-item" href="cEquipment.php?id=C_1" >Equipment Rental</a>
    <a class="dropdown-item" href=" cEquipmentOrder.php?id=C_1" >Equipment Order</a>
              ...
              ?>
              <a class="dropdown-item" href="cMessageSupplier.php?id=C_1" >Question & Answer</a>
          </div>
        </li>
    ...
    <div class="modal fade" id="equipmentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="cEquipment.php?id=C_1">Go!</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
           <?php
              echo"<a class='btn btn-primary' href='cRating.php?id=".$id1." '>Go</a>";
