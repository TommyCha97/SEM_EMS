...
?> 
    ...
    <label for="Receipt_ID" class="font">Receipt ID</label>
    <label for="Dot" class="dot">:</label>
    <label class="font1"><?php echo ($PaymentID[$l]); ?></label>
  </div>
  ...
  <div class="form-group">
    <label for="C_name" class="font">Customer Name</label>
    <label for="Dot" class="dot">:</label>
    <label class="font1"><?php echo ($C_name[$l]); ?></label>
  </div>

  <div class="form-group">
    <label for="CreditCard_Number" class="font">Credit Card Number</label>
    <label for="Dot" class="dot">:</label>
    <label class="font1"><?php echo ($CreditCard_Number[$l]); ?></label>
  </div>
  ...
  <div class="form-group">
    <label for="EOd_totalPrice" class="font">Total Price</label>
    <label for="Dot" class="dot">:</label>
    <label class="font1">RM <?php echo ($z); ?></label>
      ...
      <tr cellpadding="20">
        ...
        <tr>
        <td><button name ="print" class="btn btn-primary" onclick="myFunction()"> Print Invoice </button></td>
        <td><a href="customerMenu.php"><input type="button" class="btn btn-primary" name="cancel" value="Cancel"></a>
        </tr>
