...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="supplierMenu.php">Event Management System</a>
...
$id1=$_GET['id'];
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="supplierMenu.php">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="supplierMenu.php">Home</a>
            </li>
...
<div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              ...
              <div class="col-xl-3 col-sm-6 mb-3"> </div>
               <button type="button" class="btn btn-info w-100" onclick="window.location.href='sViewEventPackage.php?id=S_1'" >View Event Package</button>
...
<div class="col-xl-3 col-sm-6 mb-3">
              ...
              <div class="col-xl-3 col-sm-6 mb-3"> </div>
               <button type="button" class="btn btn-info w-100" onclick="window.location.href='sEquipmentOrder.php?id=S_1'" >View Equipment</button>
...
<div class="col-xl-3 col-sm-6 mb-3">
              ...
              <div class="col-xl-3 col-sm-6 mb-3"> </div>
               <button type="button" class="btn btn-info w-100" onclick="window.location.href='sStatus.php'" >Proceed status profile</button>
    ...
    <div class="modal fade" id="packageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="sViewEventPackage.php?id=S_1">Go!</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="equipmentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="sEquipmentOrder.php?id=S_1">Go!</a>
          </div>
        </div>
      </div>
    </div>
